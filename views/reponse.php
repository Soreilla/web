...
<!-- jQuery -->
<script src="back/js/jquery-2.1.4.min.js"></script>
<!-- //jQuery -->
<link href='//fonts.googleapis.com/css?family=Roboto:700,500,300,100italic,100,400' rel='stylesheet' type='text/css'/>
<link href='//fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet' type='text/css'>
<!-- lined-icons -->
<link rel="stylesheet" href="back/css/icon-font.min.css" type='text/css' />
<!-- //lined-icons -->
<!--//tables-->
<link rel="stylesheet" type="text/css" href="back/css/table-style.css" />
<link rel="stylesheet" type="text/css" href="back/css/basictable.css" />
<script type="text/javascript" src="back/js/jquery.basictable.min.js"></script>
...
<!--heder end here-->
  ...
  <h2>Repondez a cette reclamation</h2>
	<span>
		<!-- Reponse donnée par l'admin-->
...
<div class="clearfix"> </div>
           <!-- <div class="col-md-12 form-group1 group-mail">
            ...
            <div class="col-md-12 form-group1 ">
              ...
              <textarea name="autre" placeholder="Votre Reponse....." required=""></textarea>

            </div>
             <div class="clearfix"> </div>
            <div class="envoyer">

          <!-- Ici tu va srenvoyer a insererReponse 
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									...
									<li id="menu-academico" ><a href="errorpage.html"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i><span>Error Page</span><div class="clearfix"></div></a></li>
									  <li id="menu-academico" ><a href="#"><i class="fa fa-cogs" aria-hidden="true"></i><span> Suivi</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										   <ul id="menu-academico-sub" >
										   <li id="menu-academico-avaliacoes" ><a href="back/avis.php">Avis</a></li>
											<li id="menu-academico-avaliacoes" ><a href="#">Après Vente</a></li>
										  </ul>
										</li>
