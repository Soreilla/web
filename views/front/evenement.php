...
<body> 
	...
	<div class="banner">
		...
		<div class="banner-text w3labout-bnr"> 
			<div class="container">  
				<h2><a href="index.php">Home</a> / Evenements</h2>   
			</div>
		</div>
		<!-- //banner-text -->
	</div>
	...
	<div class="contact">
		<div class="container">  
			<div class="w3ls-title"> 
				<h3 class="agileits-title">Reserver une place</h3>
			</div>
				...
				<div class="col-md-6 col-sm-6 contact-w3lsleft">
					<div class="contact-grid agileits">
						...
						<form action="#" method="post"> 
							...
							<input type="text" name="Phone Number" placeholder="Numero de télephone" required="">
				            <input type="Number" name="Nombre de place" placeholder="Nombre de place" required=""><br>
				            <br>
	...
	<div class="footer">
		<div class="container">
			<div class="col-md-5 col-sm-5 agileinfo_footer_grid">
				...
				<p>Nous sommme un restaurant à specialité italienne/tunisienne. <span>.</span></p>
			</div>
			...
			<div class="col-md-4 col-sm-4 agileinfo_footer_grid">
				...
				<ul>
					<li><span class="glyphicon glyphicon-home" aria-hidden="true"></span> 31 rue les mimosas</li>
