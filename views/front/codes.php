...
<html lang="en">
<head>
<title>Dine a Hotels and Restaurants Category Bootstrap Responsive website Template | Short Codes :: w3layouts</title>
...
<body> 
	...
	<div class="banner">
				...
				<div class="menu">
					...
					<div class="toggle"> 
						<ul class="toggle-menu">
							...
							<li><a href="codes.php" class="active"> Short Codes</a></li>
		...
		<div class="banner-text w3labout-bnr"> 
			<div class="container">  
				<h2><a href="index.php">Home</a> / Codes</h2>   
			</div>
		</div>
		<!-- //banner-text -->
	</div>
